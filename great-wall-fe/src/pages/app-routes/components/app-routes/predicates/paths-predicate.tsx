                ...
                <HoverCardContent>
                  <p>
                    ...
                    <ul>
                      ...
                      <li>&#123;*spring&#125; 匹配零个或多个 路径段 ，直到路径的末尾，并将其捕获为名为“spring”的变量</li>
                    </ul>
                  </p>
                  <b>
                  ...
                  <p>
                    <b>例子</b>
                    <ul>
                      <li>/pages/t?st.html — 匹配 /pages/test.html，/pages/tXst.html 但不匹配 /pages/toast.html</li>
                      ...
                      <li>/resources/&#123;*path&#125; — 匹配 和 下的所有文件 /resources/， /resources并在名为 “path”
                        的变量中捕获它们的相对路径
                      </li>
                      <li>/resources/image.png 将与 “path” 匹配 → “/image.png”，并将 /resources/css/spring.css 与 “path”
                        匹配
                        → “/css/spring.css”
                      </li>
