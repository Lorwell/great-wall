...
import {
  ...
  RemoveResponseHeadersFilterSchemaValues
 ...
 * @constructor
 */
export default function RemoveResponseHeaders(props: RoutesProps<RemoveResponseHeadersFilterSchemaValues>) {
  const {
    value,
    onChange,
    onRemove,
  ...
  const form = useForm<RemoveResponseHeadersFilterSchemaValues>({
    resolver: zodResolver(removeResponseHeadersFilterSchema),
    defaultValues: {...(value || {headerNames: [{value: ""}]}), type: RouteFilterEnum.RemoveResponseHeaders},
   ...
   * @param data
   */
  async function onSubmit(data: RemoveResponseHeadersFilterSchemaValues) {
    await onChange?.(data)
  }
